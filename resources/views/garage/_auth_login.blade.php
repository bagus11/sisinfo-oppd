                                ...
                                <div class="row">
                                    <div class="col-6 mb-2 mb-sm-0">
                                        <a class="btn btn-link border border-muted d-flex align-items-center justify-content-center rounded-2 py-8 text-decoration-none"
                                            ...
                                            <img src="{{ asset('assets/images/svgs/google-icon.svg') }}" alt="matdash-img"
                                    ...
                                    <div class="col-6">
                                        <a class="btn btn-link border border-muted d-flex align-items-center justify-content-center rounded-2 py-8 text-decoration-none"
                                            href="javascript:void(0)" role="button">
                                            <img src="{{ asset('assets/images/svgs/facebook-icon.svg') }}" alt="matdash-img"
                                                class="img-fluid me-2" width="18" height="18" />
                                            Facebook
                                        </a>
                                    </div>
                                ...
                                <form>
                                    ...
                                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                        ...
                                        <a class="text-primary fw-medium"
                                            href="{{ route('home') }}">Forgot Password ?</a>
                                    </div>
                                    <a href="{{ route('home') }}" class="btn btn-primary w-100 py-8 mb-4 rounded-2">Sign In</a>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <p class="fs-4 mb-0 fw-medium">New to MatDash?</p>
                                        <a class="text-primary fw-medium ms-2"
                                            href="{{ route('home') }}">Create an
                                            account</a>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="d-lg-flex align-items-center z-index-5 position-relative h-n80">
                            <div class="row justify-content-center w-100">
                                <div class="col-lg-6">
                                    ...
                                    <span class="opacity-75 fs-4 text-white d-block mb-3">MatDash helps developers to
                                        build organized
                                        and well
                                        <br />
                                        coded dashboards full of beautiful and rich modules.
                                    </span>
                                    <a href="{{ route('home') }}" class="btn btn-primary">Learn More</a>
                                </div>
                            </div>
                        </div>
                    </div>
