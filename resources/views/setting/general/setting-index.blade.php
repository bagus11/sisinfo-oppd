...
<style>
    .select2-container {
        z-index: 1050 !important; /* Sesuaikan dengan modal jika perlu */
    }
    #cropContainer {
        text-align: center;
    }
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-4 order-last">
                  <ul class="list-unstyled d-flex align-items-center justify-content-center justify-content-lg-end my-3 mx-4 pe-4 gap-3">
                    <li>
                        <button class="btn btn-info"><i class="fa-solid fa-image-portrait" id="btn_change_image"></i></button>
                    </li>
                    <li>
                      <button class="btn btn-danger"><i class="fa-solid fa-key" id="btn_change_pass"></i></button>
                    </li>
                  </ul>
                </div>
              </div>
