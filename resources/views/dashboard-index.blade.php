...
.col-12 {
  ...
  .row {
    ...
    ::-webkit-scrollbar {
      ...
      .modal.fade {
          transform: none !important;  /* Ensure no scaling on modal */
      }
...
<div class="row mb-0" id="content-wrapper">
  <!-- Asset Infografis Section -->
  <div class="col-12 col-sm-12 col-md-9">
    <div class="card">
      <div class="card-body p-0">
        <span class="badge badge-primary w-15 mb-2 mx-2 my-2" 
              style="background-color:#7298AD;color:white;border-radius:5px !important;font-size:12px !important; font-weight:bold;">
          ASSET INFOGRAFIS
        </span>
...
<div class="col-12">
  <div class="row overflow-auto flex-nowrap" id="satgas_type_container" 
       style="white-space: nowrap; overflow-x: auto; -webkit-overflow-scrolling: touch;">
  </div>
</div>
