...
if (isSidebar.length > 0) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function handleTheme() {
      ...
      let user_theme = $('#user_theme').val();
      
      // Initialize theme based on `user_theme` value
      if (user_theme == 1) {
  ...
  $('.setting_dark').on('click', function(){
    var user_theme = $('#user_theme').val();
    postCallbackNoSwal('changeDarkTheme', null, function(response){
      user_theme == 1 ? $('#user_theme').val(0) : $('#user_theme').val(1)
